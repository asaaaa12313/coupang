...
def setup_sheet(spreadsheet_url: str):
    ...
    # 샘플 데이터
    samples = [
        [1, "맛있는치킨", "123456", "123-45-67890", "ORD-2025-0001", "2025-02-15",
         "블라인드&게시중단 중복", "", ""],
        [2, "행복한분식", "789012", "987-65-43210", "ORD-2025-0002", "2025-02-16",
         "블라인드&게시중단 중복", "", ""],
        [3, "정성카페", "345678", "111-22-33333", "ORD-2025-0003", "2025-02-17",
         "블라인드&게시중단 중복", "", ""],
    ]
    ...
    sheet_id = ws1.id
    requests = []
    widths = [50, 120, 120, 170, 150, 120, 150, 120, 160]
